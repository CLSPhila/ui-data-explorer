...
maxYear <- getMaxYear(ucAppealsCaseAgingLower)
minYear <- getMinYear(ucAppealsCaseAgingLower)
maxDate <- max(ucAppealsCaseAgingLower$rptdate)
minDate <- min(ucAppealsCaseAgingLower$rptdate)
